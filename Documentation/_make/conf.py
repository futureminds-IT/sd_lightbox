# -*- coding: utf-8 -*-
#
# Lightbox by Tim Tilch documentation build configuration file, created by
# TYPO3 extension sphinx on Tue, 19 Apr 2016 13:34:36 +0200.
#
...
project = u'Lightbox by Tim Tilch'
copyright = u'2016, Tim Tilch'
...
htmlhelp_basename = 'timtilch_lightboxdoc'
...
latex_documents = [
    ('Index', 'timtilch_lightbox.tex', u'Lightbox by Tim Tilch',
     u'Tim Tilch', 'manual'),
]
...
pdf_documents = [
    ('Index', 'timtilch_lightbox', u'Lightbox by Tim Tilch',
     u'Tim Tilch'),
]
...
texinfo_documents = [
    ('Index', 'timtilch_lightbox', u'Lightbox by Tim Tilch',
     u'Tim Tilch', 'Lightbox by Tim Tilch', 'One line description of project.',
     'Miscellaneous'),
]
